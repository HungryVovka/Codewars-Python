# -----------------------------------------------------------
# Create a function taking a positive integer between 1 and 3999 (both included) as its parameter and returning a string containing the Roman 
...
def solution(n):
    number_roman = {1000: "M",
                    ...
                    1: "I"}
    roman_numeral = ""
    for number, roman in number_roman.items():
        while n >= number:
            roman_numeral += roman
            n -= number
